/*
 ...
 This script is idempotent: it can be executed repeatedly without dropping
 tables, deleting business data, duplicating seed data, indexes, or constraints.
 Run the complete file in SSMS or another client that supports GO.
*/
...
PRINT 'EmployeeSignatureDB schema is ready. This script may be run again safely.';
GO
